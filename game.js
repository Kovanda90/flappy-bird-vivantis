class FlappyBirdGame {
    constructor() {
        ...
        this.basePipeInterval = 2000; // Základní interval mezi trubkami - rychlejší start
    ...
    updateDifficulty() {
        ...
        // Interval mezi trubkami - každých 15 bodů -100ms, minimum 1500ms (rychlejší zmenšování)
        this.pipeInterval = Math.max(1500, this.basePipeInterval - (this.score / 15) * 100);
